...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Creating of object referances to eachive other classes and methods.
        ...
        if(choiseCalc == 1) {
            ...
            turkishStyleCalculator.displayResult(result); //Shows the results in "TR" style.
            ukStyleCalculator.displayResult(result); //Shows the results in "UK" style.
